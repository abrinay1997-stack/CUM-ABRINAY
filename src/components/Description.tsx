  ...
  return (
    <section id="description" className="py-24 px-4 bg-[#0a0a0a] relative overflow-hidden">
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        >
          {/* Holographic Card */}
          <div className="bg-black/40 border border-white/10 rounded-3xl p-8 md:p-12 shadow-[0_0_50px_rgba(188,19,254,0.1)] relative overflow-hidden">
            ...
            <div className="space-y-6 mb-12">
              <p className="text-2xl md:text-4xl text-white font-cyber font-bold tracking-widest uppercase" style={{ textShadow: '0 0 10px rgba(0,243,255,0.5)' }}>
            ...
            <div className="mt-12 p-8 border border-neon-pink/30 bg-neon-pink/5 rounded-xl relative group hover:bg-neon-pink/10 transition-colors duration-500">
              <div className="absolute inset-0 bg-neon-pink/20 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
              <p className="text-neon-pink font-cyber tracking-[0.2em] uppercase text-sm mb-3">DRESS CODE</p>
              <p className="text-white text-2xl md:text-3xl font-cyber font-bold italic mb-2" style={{ textShadow: '0 0 10px rgba(255,0,255,0.5)' }}>"Sexy"</p>
